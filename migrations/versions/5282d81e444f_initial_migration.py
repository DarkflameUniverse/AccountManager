...
def upgrade():
    ...
    sa.Column('id', mysql.BIGINT(), nullable=False),
    sa.Column('per_name', mysql.TEXT(), nullable=False),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name'),
    sa.UniqueConstraint('pending_name'),
    ...
    sa.Column('clone_id', mysql.BIGINT(unsigned=True), nullable=False),
    sa.Column('name', mysql.TEXT(), nullable=False),
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.execute(
      sa.schema.DropSequence(sa.Sequence('property_clone_id_seq'))
    )
